...
export default function FoodChartPage(props) {
  ...
  var SAWheat2018 = [['ReporterCountries', 'PartnerCountries', 'Value'],
  ...
  var PieSAWheat2020 = [['PartnerCountries', 'Value'],
  ['Australia', 0],
  ['Brazil', 62460],
  ['Egypt', 0],
  ['Estonia', 0],
  ...
  var PieSAWheat2019 = [['PartnerCountries', 'Value'],
  ['France', 11],
  ['Germany', 139850],
  ['Italy', 37],
  ['Lithuania', 259583],
  ...
  var PieSAWheat2018 = [['PartnerCountries', 'Value'],
  ['France', 191477],
  ['Germany', 257434],
  ['Italy', 6],
  ['Latvia', 129703],
  ...
  var PieSARice2020 = [['PartnerCountries', 'Value'],
  ['Argentina', 519],
  ['Australia', 4316],
  ['Bangladesh', 3798],
  ['Brazil', 9836],
  ...
  var EgyptWheat2018 = [['Reporter Countries', 'Partner Countries', 'Value'],
  ...
  var EgyptRice2020 = [['Reporter Countries', 'Partner Countries', 'Value'],
  ['Egypt', 'Australia', 0],
  ['Egypt', 'Bahrain', 0],
  ['Egypt', 'Cambodia', 4],
  ...
  var EgyptRice2019 = [['Reporter Countries', 'Partner Countries', 'Value'],
  ...
  var EgyptRice2018 = [['Reporter Countries', 'Partner Countries', 'Value'],
  ...
  var PieEgyptWheat2018 = [['Partner Countries', 'Value'],
  ['Australia', 264309],
  ['Belarus', 67604],
  ['Bulgaria', 57741],
  ['Canada', 34901],
  ...
  var PieEgyptRice2020 = [['Partner Countries', 'Value'],
  ['Australia', 0],
  ['Bahrain', 0],
  ['Cambodia', 4],
  ...
  var PieEgyptRice2019 = [['Partner Countries', 'Value'],
  ['Brunei Darussalam', 1],
  ...
  var PieEgyptRice2018 = [['Partner Countries', 'Value'],
  ...
  return (
    <div>
      ...
      <div className='row'>
        <div className='col-md-2' style={{"background-color":"#white"}}><NavBar /></div>
        ...
        <div className='col-md-8 main-container'>
          <div className="row">
            ...
            <div className="row">
              <div id='chart-area'>
                <CustomCharts displayChart={displayChart} options={options} displayPie={displayPie} />
              </div>
            </div>
          </div>
        </div>
